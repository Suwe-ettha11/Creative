                ...
                <div class="col-md-9">
                    ...
                    <form action="acc.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="aname" class="control-label">Full Name</label>
                            <input type="text"  class="form-control"placeholder="Enter your Name" 
                            name="name">

                        </div>
                        <div class="form-group">
                            <label for="aprice" class="control-label">Phone-Number</label>
                            <input type="text" placeholder="Enter your Phone number" class="form-control" name="cus_phno">

                        </div>
                        <div class="form-group">
                            <label for="qty" class="control-label">Alternate Number</label>
                            <input type="number" placeholder="Enter your Alternate number" 
                            class="form-control" name="alt_phno">

                        </div>
                        <div class="form-group">
                            <label for="des" class="control-label">Address</label>
