                            ...
                            <div class="product-tab-wrapper">
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="product-item mb-50">
                                            <div class="product-thumb">
                                                <a href="display15_6_40pin.html">
                                                    <img src="assets/img/product/display/display15_6_40pin/product-1.jpg" alt="" style="height:250px !important; width:250px !important;">
                                                </a>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="product-item mb-50">
                                            <div class="product-thumb">
                                                <a href="display15_6_30pin.html">
                                                    <img src="assets/img/product/display/display15_6_30pin/product-1.jpg" alt="" style="height:250px !important; width:250px !important;">
                                                </a>
                                                <div class="quick-view-link">
                                                    <a href="display15_6_30pin.html"> <span
                                                            data-toggle="tooltip" title="Quick view"><i
                                                            class="ion-ios-eye-outline"></i></span> </a>
                                                </div>
                                            </div>
                                            <div class="product-content text-center">
                                                ...
                                                <div class="product-name">
                                                    <h4 class="h5">
                                                        <a href="product-details.html">Laptop Display Screen 15.6″ 30 PIN Paper LED </a>
                                                    </h4>
                                                </div>
                                                <div class="price-box">
