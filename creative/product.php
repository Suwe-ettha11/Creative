                                ...
                                <li><a href="#">Laptop Spare <i class="fa fa-angle-down"></i></a>
                                    <ul class="megamenu dropdown">
                                        <li class="mega-title"><a href="#">column 01</a>
                                            <ul>
                                                <li><a href="#">Laptop Screen</a></li>
                                                <li><a href="#">Mother Board</a></li>
                                                <li><a href="#">Battery</a></li>
                                                <li><a href="#">Display Cable</a></li>
                                        ...
                                        <li class="mega-title"><a href="#">column 02</a>
                                            <ul>
                                                ...
                                                <li><a href="#">Fl / Inveter</a></li>
                                                <li><a href="#">Hinges & cap</a></li>
                                                <li><a href="#">Heatsing Fan</a></li>
                                                <li><a href="#">Laptop Panel</a></li>
                                            </ul>
                                        </li>
                                ...
                                <div class="row">
                                        ...
                                        <div class="product-item mb-50">
                                            <div class="product-thumb">
                                                <a href="product-details.html">
                                                    <img src="assets/img/product/Laptop Screen/product-1.jpg" alt="" style="height:250px !important; width:250px !important;">
                                                </a>
                                            ...
                                            <div class="product-content text-center">
                                                ...
                                                <div class="product-name">
                                                    <h4 class="h5">
                                                        <a href="product-details.html">Laptop Display Screen 15.6″ 40 PIN Paper LED </a>
                                                    </h4>
                                                </div>
                                                <div class="price-box">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="product-item mb-50">
                                            <div class="product-thumb">
                                                <a href="product-details.html">
                                                    <img src="assets/img/product/product-2.jpg" alt="" style="height:250px !important; width:250px !important;">
                                                </a>
                                                <div class="quick-view-link">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="product-item mb-50">
                                            <div class="product-thumb">
                                                <a href="product-details.html">
                                                    <img src="assets/img/product/product-3.jpg" alt="" style="height:250px !important; width:250px !important;">
                                                </a>
                                                <div class="quick-view-link">
                                                    <a href="#" data-toggle="modal" data-target="#quick_view"> <span
                                                            data-toggle="tooltip" title="Quick view"><i
                            ...
                            <div class="footer-widget-body">
                                <ul class="location-wrap">
                                    <li>
                                        ...
                                        <p>456 ,GST Complex,II Floor,<Br> Old Bus stand,
