...
$id=$_GET['id'];
$query = "SELECT acc_name,acc_price FROM acc_tbl where id=$id";
...
<form action="s1.php" method="GET">
    ...
    <input type="text" name="pro_name"value="<?php echo ($row['acc_name']);?> "><br><br>
    <label>Product Price</label>
    <input type="text" name="pro_price"value="<?php echo ($row['acc_price']);?> "><br><br>
   <div class="form-group">
