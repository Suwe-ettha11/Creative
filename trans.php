...
<?php
$id=$_GET['id'];
$query = "SELECT * FROM spare_table where id=$id";
...
<form action="test2.php" method="POST">
    ...
    <input type="text"class="form-control" name="pro_name"value="<?php echo ($row['pro_name']);?> "><br>
    <label class="control-label">Product Price</label><br>
    <input type="text" class="form-control"name="pro_price" value="<?php echo($row['pro_price']);?>"><br>
